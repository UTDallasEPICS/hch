  ...
  async function uploadFile() {
    ...
    try {
      ...
      toast.add({
        ...
        description: 'Your completed Physician Statement Form has been uploaded.',
        color: 'success',
      })
      await refresh()
    } catch (error: any) {
  ...
  <main class="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="mb-8">
      ...
      <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
        Download the template PDF, complete it with your physician, and upload the completed form.
      </p>
    </div>
    ...
    <template v-else>
      ...
      >
        ...
        <UButton
          :to="progress?.templateUrl || '/physician-statement-form.pdf'"
          target="_blank"
          ...
          variant="soft"
        >
          Download Physician Statement PDF
        </UButton>
      </div>
