      ...
      <div v-else class="divide-y divide-gray-200 dark:divide-gray-800">
        ...
        >
          <div class="flex items-center gap-3">
            <UAvatar :alt="capitalizeName((user.name ?? '').replace(/\|\|/g, ' '))" :src="user.image || undefined" size="md" />
            <div>
              <p class="font-medium text-gray-900 dark:text-white">{{ capitalizeName((user.name ?? '').replace(/\|\|/g, ' ')) }}</p>
